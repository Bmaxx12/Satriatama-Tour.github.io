...
if (isset($_POST['submit'])) {
  ...
  $lastname = $_POST['a2'];
  $email = $_POST['a3'];
  $identity_id = $_POST['a4'];
  $phone = $_POST['a5'];
  $dob = $_POST['a6'];

  $query = "select * from accounts where (identity_id='$identity_id' or phone='$phone' or email='$email') and aid != $aid ";
  ...
  if (preg_match('/\D/', $identity_id) || strlen($identity_id) != 16) {
    echo "<script> alert('invalid Identity_id'); setTimeout(function(){ window.location.href = 'profile.php'; }, 10); </script>";
    exit();
  }
  if (preg_match('/\D/', $phone) || strlen($phone) != 12) {
    echo "<script> alert('invalid number'); setTimeout(function(){ window.location.href = 'profile.php'; }, 10); </script>";
    exit();
  }

  $query = "UPDATE ACCOUNTS SET afname = '$firstname', alname='$lastname', email='$email', phone='$phone', identity_id='$identity_id', dob='$dob' WHERE aid = $aid";
...
<body>
    ...
    <div class="sidenav">
        <div class="profile">
            <img src="https://i.pinimg.com/236x/4a/38/5a/4a385aedddead8a90ff47a60e71e5fa4.jpg" alt="" width="100" height="100">
        ...
        <div class="main">
            ...
            <div class="card">
              ...
              <tr>
                <td>identity_id</td>
                <td>:</td>
                <td><input name='a4' type='text' value='$identity_id'></td>
              </tr>
              <tr>
              <td>Phone</td>
              <td>:</td>
